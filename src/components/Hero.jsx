...
function Hero() {
  return (
    <section className={`flex flex-col md:flex-row ${paddingY}`} id="home">
      <div className={`flex-1 ${flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <img src={discount} alt="Discount Image" className="w-[32px] h-[32px]" />
        ...
        <p className={`${paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs. We examine annual percentage rates, annual fees.</p>
      </div>

      <div className={`flex-1 flex ${flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="Robot Image" className="w-[100%] h-[100%] relative z-[5]" />
